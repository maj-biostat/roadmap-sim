...
cols <- c("Domain", "Randomised", "Treatment", "Surgery recvd", "DAIR", "Revision", "Total")
...
gt_tbl <- d_tbl |> 
  ...
  tab_footnote(
    footnote = "Randomised indicates whether units were randomised into choice/duration domain (0: No, 1: Yes)",
...
# domain B
d_tmp1 <- d[ed == 1, .(ed, d, er, r, ic,srp)]
...
cols <- c("Domain", "Randomised", "Treatment", c("long", "short", "long", "short"), "Total")
names(cols) <- names(d_tbl)
...
gt_tbl <- d_tbl |> 
  ...
  cols_label(.list = cols)  |>
  tab_footnote(
    footnote = "Randomised indicates whether units were randomised into surgery/duration domain (0: No, 1: Yes)",
    locations = cells_column_labels(columns = rand)
  ) |>
  tab_footnote(
...
cols <- c("Domain", "Randomised", "Surgery recvd", "Treatment", c("norif", "rif"), "Total")
names(cols) <- names(d_tbl)
...
gt_tbl <- d_tbl |> 
  ...
  cols_label(.list = cols)|>
  tab_footnote(
    footnote = "Randomised indicates whether units were randomised into surgery/choice domain (0: No, 1: Yes)",
    locations = cells_column_labels(columns = rand)
  ) |>
  tab_footnote(

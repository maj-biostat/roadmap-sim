...
Here, we know there is an effect of one-stage (but not two-stage) and would hope that a decision for superiority is made such that new participants are directed to receive revision.

...
We assume the following SWIGs as a simplified representation of how patients reach their treatment status across the domains.

Figre @fig-late-silo shows the SWIGs applicable to the late silo with each showing a different counterfactual world.
The SWIGs make clear the variables on which we intervene and all other variables and allow us to read the presence of exchangeability directly from the graph.
The vertical line in the split nodes blocks paths and thus indicates, for example, that a treatment is independent of the potential outcome for all levels of the treatment.

![Late silo SWIGs](../fig/swig-late-01.png){width=100% #fig-late-silo}


![Early/chronic silo SWIGs](../fig/swig-early-01.png){width=100%}

...
d_fig[, quant := factor(quant, 
                        levels = c("sup", "fut_sup", "inf", "fut_inf","trt_ni_ref", "fut_trt_ni_ref"))]
...
d_text[parname_lab == "short vs ref (two)" & or_tru %in% c("OR 1/2"),
       `:=`(label = c("short sup \nto long"), x = 500, y = 0.2)]
d_text[parname_lab == "short vs ref (two)" & or_tru %in% c("OR 2"),
       `:=`(label = c("short fut (sup)"), x = 500, y = 0.2)]
...
d_fig$quant <- factor(
  d_fig$quant, 
  levels = c("sup", "fut_sup", "inf", "fut_inf", "trt_ni_ref", "fut_trt_ni_ref"),
  labels = c("sup", "fut_sup", "inf", "fut_inf", "ni", "fut_ni"))
...
# analysis
d_tbl <- d_fig[quant %in% c("sup", "fut_sup", "inf", "fut_inf", "ni", "fut_ni")]

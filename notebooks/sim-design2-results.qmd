...
Some commentary is necessary on the interpretation of parameters.
...
+ $\alpha_{[early, \cdot]}$ term in the model describes the log-odds of treatment success for early infection silo members who were randomised^[That is, not part of the 40% exclusion set from domain C] to no-rif and had no randomisation options for domains A and B.
+ $\alpha_{[late, \cdot]}$ term in the model describes the log-odds of treatment success for late infection silo members who were randomised to dair in Domain A, had no randomisation options for Domain B^[A deterministic consequence of being randomised to dair in Domain A] and were randomised to no-rif in Domain C.

...
We do not know the assignment mechanism for one vs two-stage for the late-stage infection patients.
We do the same for chronic stage patients.
...
early | dair | dair | - | 
late | dair |  dair |   - | 
late | revision |  one-stage | 0.3 | 
late | revision |  two-stage | 0.7 | 
chronic | dair | dair | 0.2 | 
chronic | one-stage |  one-stage | 0.2 | 
chronic | two-stage |  two-stage | 0.6 | 
...
Silo | Allocation/Intended surgery ($q$) | Allocation ($b$) | $\pi$ |
-----|-----|----|---|
early | dair | 12 wk |  - | 
late | one-stage | 6 wk |  0.5 | 
late | one-stage | 12 wk |  0.5 | 
late | two-stage | 7 day post 2  |  0.5 | 
late | two-stage | 12 wk post 2  |  0.5 | 
chronic | one-stage | 6 wk |  0.5 | 
chronic | one-stage | 12 wk |  0.5 | 
chronic | two-stage | 7 day post 2  |  0.5 | 
chronic | two-stage | 12 wk post 2  |  0.5 | 
...
: Allocation within antibiotic choice domain ($\pi$ denotes probability that an eligible patient is allocated to no rif vs rif) {.striped .hover}
:::

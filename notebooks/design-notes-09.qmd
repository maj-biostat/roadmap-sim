...
Here I change the approach to computing the interaction part of the design matrix and simply use `kronecker(Q_a, Q_b)`.
This doesn't seem to recover the parameters correctly even though the approach makes more sense.

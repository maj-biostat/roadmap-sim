...
This will be used as the running example.
...
In @fig-dag-mcar, the indicator of missingness ($m$) arises as a function of an independent process - it has nothing to do with the observed or unobserved covariates or response.
...
There isn't really any benefit to imputation when the missing data mechanism is MCAR.
...
In @fig-dag-mar, the indicator of missingness arises as a function of the exposure ($x$).
